...
Scripts/package-chromium-app.sh 0.9.8 985 Release
# 产物：Dist/Rex.app 与 Dist/Rex-v0.9.8-macos-arm64-chromium.zip
```

build 985 的本地 Beta 包已经生成：`Dist/Rex.app`（344M）与
`Dist/Rex-v0.9.8-macos-arm64-chromium.zip`（143,061,961 bytes / 145M），ZIP
SHA-256 为 `680079eacab39fe2907132cc91e1eb9c1dff8e9c9fed29adb5c437993cb99651`。
