...
| V098-DL-01 | 增加危险下载判定与确认 | 可执行、脚本、双扩展名和 MIME 不一致样本均有正确提示 |
| V098-PRIVATE-01 | 明确隐私窗口下载落盘 | 保存前提示；文件可落盘，但不写入普通历史和下载资料库 |
