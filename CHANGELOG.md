...
- 产物：`Dist/Rex-v0.8.1-macos-arm64-chromium.zip`（143,463,111 bytes；`du` 约 144M）/ `Dist/Rex.app`（约 344M）。
- ZIP SHA-256：`4ac97aff8b20bfd966154c58ed639c99aa63d40a118d49466aee945a0b640e08`；压缩数据完整性校验通过。
